...
- **Favicon**: Added a clean serif monogram **"O"** in `app/icon.svg`.
...
- **GitHub Pages Deployment**: Added `scripts/export.mjs` static HTML generator and automated `.github/workflows/deploy.yml` workflow for automatic GitHub Pages deployment.
